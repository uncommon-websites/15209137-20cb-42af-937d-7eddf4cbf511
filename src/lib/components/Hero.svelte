<section class="bg-[#f5f5f5] px-6 pt-16 pb-0">
  <div class="max-w-[1400px] mx-auto">
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16">
      <div class="lg:col-span-7">
        <h1 class="font-serif text-5xl md:text-6xl lg:text-[64px] leading-[1.1] tracking-tight text-gray-900">
          One platform for banking, crypto, and startup investing
        </h1>
      </div>
      <div class="lg:col-span-5 flex flex-col justify-between">
        <p class="text-gray-500 text-lg max-w-md leading-relaxed">
          Tired of juggling multiple apps? BlendFi unifies your traditional banking, cryptocurrency portfolio, and startup investments in one secure, non-custodial platform.
        </p>
      </div>
    </div>
    ...
    <div class="relative w-full h-[600px] overflow-hidden rounded-sm bg-primary-800">
      <!-- Image Overlay -->
      <img 
        src="/generated/image-young-professional-using-smartphone-for--1765519873419-0.webp" 
        alt="Professional using BlendFi mobile app" 
